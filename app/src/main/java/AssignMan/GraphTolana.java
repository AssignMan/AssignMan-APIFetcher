...
public class GraphTolana {
    ...
    static void listCalendarEvents(String timeZone) {
        ZoneId tzId = GraphTolana.getZoneIdFromWindows("Pacific Standard Time");
        ...
        List<Event> events = GraphCalenders.getCalendarView(
